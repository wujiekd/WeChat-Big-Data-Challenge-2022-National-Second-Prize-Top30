...
NEW_DIR = 'opensource_models/pretrain-model/macbert-base'
...
NEW_DIR = 'opensource_models/pretrain-model/roberta-wwm'
print('Transformers version',transformers.__version__) 
...
pretrained_model_name_list = ['hfl/chinese-roberta-wwm-ext']
transformers_model_dowloader(pretrained_model_name_list, is_tf = False)
print("Download finish")
